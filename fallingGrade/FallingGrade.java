...
public class FallingGrade extends JFrame {
	...
	// 배경 이미지 생성
	private Image backGroundImage = new ImageIcon(".\\bin\\Data\\startPage.png").getImage();

	// 메뉴바 이미지 생성
	private JLabel menuBar = new JLabel(new ImageIcon(".\\bin\\Data\\NO_USE.png"));
	// 메뉴바 종료 이미지 생성
	private ImageIcon menuBarExitBasicImage = new ImageIcon(".\\bin\\Data\\exitGame.png");
	private ImageIcon menuBarExitMouseImage = new ImageIcon(".\\bin\\Data\\exitGameOnMouse.png");
	...
	private ImageIcon exitButtonMouseImage = new ImageIcon( // 마우스 올려졌을 경우 이미지
			".\\bin\\Data\\endOnMouse.png");

	private Image selectPlayerImage = new ImageIcon(".\\bin\\Data\\selectPlayerPage.png").getImage();
	private boolean selectPlayerPage = false;

	// 캐릭터선택 이미지 생성
	private ImageIcon kibokBasicImage = new ImageIcon( // 기본 상태 이미지
			".\\bin\\Data\\character1Basic.png");
	private ImageIcon kibokMouseImage = new ImageIcon( // 마우스 올려졌을 경우 이미지
			".\\bin\\Data\\character1Mouse.png");
	private ImageIcon junhyeonBasicImage = new ImageIcon( // 기본 상태 이미지
			".\\bin\\Data\\character2Basic.png");
	private ImageIcon junhyeonMouseImage = new ImageIcon( // 마우스 올려졌을 경우 이미지
			".\\bin\\Data\\character2Mouse.png");

	// 난이도 선택요구 이미지 생성
	private Image selectDifficultyImage = new ImageIcon(".\\bin\\Data\\selectDifficultyPage.png").getImage();
	...
	private ImageIcon hardMouseImage = new ImageIcon( // 마우스 올려졌을 경우 이미지
			".\\bin\\Data\\hardOnMouse.png");

	// 선택캐릭터 이미지 생성
	private Image gameImage = new ImageIcon(".\\bin\\Data\\playingGamePage.png").getImage();

	//게임 화면창
	public static boolean playingGamePage = false;

	// 게임 결과 창 생성
	private Image clearPageImage = new ImageIcon(".\\bin\\Data\\clearPage.png").getImage();
	public static boolean gameEndPage = false;
	private Image gameoverImage = new ImageIcon(".\\bin\\Data\\gameOverPage.png").getImage();
	public static boolean gameoverPage = false;

	// 다시하기 이미지 생성
	private ImageIcon restartImage = new ImageIcon(".\\bin\\Data\\restart.png"); // 기본 상태 이미지
	private ImageIcon restartOnMouse = new ImageIcon(".\\bin\\Data\\restartOnMouse.png"); // 마우스 올려졌을 경우 이미지
	...
	public FallingGrade() {
		...
		selectKibokButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent mouse) {
				...
				player.selectedPlayerImage = new ImageIcon(".\\bin\\Data\\character1Basic.png").getImage();
		...
		selectJunhyeonButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent mouse) {
				...
				player.selectedPlayerImage = new ImageIcon(".\\bin\\Data\\character2Basic.png").getImage();
				selectPlayerPage = false;
				selectDifficultyPage = true; // 난이도선택창 넘어가기
